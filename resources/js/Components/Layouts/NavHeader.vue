        ...
        <body class="bg-blue-500">
            ...
            <nav class="relative px-4 py-4 flex justify-between items-center bg-white">
                <div class="flex flex-row items-center ml-2">
                    ...
                    <span class="text-xl ml-2">ระบบจองห้องประชุม Online</span>
                </div>
                ...
                <!-- ส่วนของ Header ที่เป็นเมนู แนวนอน สามารถปรับเปลี่ยนได้ตามแต่ใครจะเอาไปใช้งานแบบไหน -->
                ...
                <a class="hidden md:inline-block md:ml-auto md:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" href="#">Sign In</a>
                <a class="hidden md:inline-block py-2 px-6 bg-blue-500 hover:bg-blue-600 text-sm text-white font-bold rounded-xl transition duration-200" href="#">Sign up</a> -->
            </nav>
            <div class="navbar-menu relative z-50 hidden">
                ...
                <nav class="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
                    ...
                    <div>
                        <ul>
                            <li class="mb-1">
                                <Link href="/primevue/inputgroup" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded">หน้าหลัก</Link>
                                <!-- <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">หน้าหลัก</a> -->
                            </li>
                            <li class="mb-1">
                                <Link href="/" class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded">จองห้องประชุม</Link>
                                <!-- <a class="block p-4 text-sm font-semibold text-gray-400 hover:bg-blue-50 hover:text-blue-600 rounded" href="#">จองห้องประชุม</a> -->
                            </li>
                            <li class="mb-1">
